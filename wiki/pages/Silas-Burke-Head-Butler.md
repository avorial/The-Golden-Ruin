...
summary: A ready-to-run Yellow King NPC with portrait, motives, tells, Paris
  abilities, and scene notes.
tags:
  - npc
visibility: players
...
<h2>At The Table</h2>
<p>Give the NPC a first impression players can act on: posture, voice, clothes, smell of tobacco or turpentine, the way they hesitate before a particular name. Keep this paragraph concrete enough that you can read it aloud.</p>
</section>
...
<p>List the clue, rumor, contradiction, or introduction this NPC can provide. If the information points to another page, add the rendered wiki link in the relationship or scene-use sections below.</p>
</section>

<section class="wiki-section">
<h2>Relationships</h2>
<p>Connect this person to two or three campaign nodes: patron, rival, dependent, creditor, student, witness, victim, or accomplice.</p>
</section>
...
| Charm | Social ease, flirtation, invitations, soft pressure. |
...
| show them a star symbol | looks toward the nearest door before answering. |
