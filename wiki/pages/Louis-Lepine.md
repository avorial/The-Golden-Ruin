...
type: npc
name: Louis Lépine
summary: Prefect of Police and modernizer whose calm authority hides a city
  constantly on the edge of disorder.
tags:
  - npc
  - people
  - police-and-thieves
...
<h2>At The Table</h2>
<p>Lépine is controlled, practical, and difficult to impress. He listens for the part of a story that requires men, horses, paperwork, and timing.</p>
</section>

<section class="wiki-section">
<h2>History</h2>
<p>As Prefect of Police, Lépine works to modernize policing and manage the public pressures of Paris. He balances reform, order, politics, and the city's talent for sudden spectacle.</p>
</section>
...
<tr><th>Tell</th><td>Asks who must be informed before asking who is guilty.</td></tr>
</tbody>
</table>
...
| If the characters... | Lépine... |
| --- | --- |
| bring a civic threat | acts quickly and expects useful facts. |
| cause public panic | becomes their problem. |
...
Lépine knows certain cases cannot be explained publicly. He keeps a private drawer of impossible reports, each stamped with a false mundane classification.

## GM Ideas

- Lépine gives the characters limited authority to prevent a scandal at an aristocratic house.
- A police modernization project uncovers a pattern of vanished files.
- He must choose between truth and public order when Carcosan evidence surfaces.
:::
