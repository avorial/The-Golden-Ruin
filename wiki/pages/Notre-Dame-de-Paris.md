...
Begun in 1163 and repeatedly damaged, altered, and restored, it holds gargoyles, long-beaked chimeras, and relics identified as the Crown of Thorns, part of the True Cross, and a Holy Nail.
...
This background is adapted from the [Notre-Dame de Paris](https://en.wikipedia.org/wiki/Notre-Dame_de_Paris) article on Wikipedia (en), accessed September 23, 2026, under the CC BY-SA license.

## Investigation Use

Stone grotesques begin changing position while a relic produces the wrong miracle.
...
- Wikipedia contributors, [Notre-Dame de Paris](https://en.wikipedia.org/wiki/Notre-Dame_de_Paris), accessed September 23, 2026.
